...
from presentation.presenters.configurations.markdown_configuration_factory import (
...
class Container(containers.DeclarativeContainer):
    ...
    element_finder: providers.Singleton = providers.Singleton(
        "infrastructure.services.element_finder.WebElementFinder", config=config
    )
